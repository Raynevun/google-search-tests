...
public abstract class AbstractWebPageSegment implements IWebPageSegment {
    ...
    public boolean isElementPresent(By locator, long explicitWaitTimeout) {
        WebElement webElement;
        WebDriver webDriver = getWebDriver();

        try {
            // remove implicitWaitTimeout( )
    ...
    public boolean isElementPresent(By locator) {
        return isElementPresent(locator, getDefaultExplicitWaitTimeout());
    }
